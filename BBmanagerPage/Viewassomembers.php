...
if(mysqli_num_rows($res)>0)
{
    ...
    $result_set = mysqli_query($con,"SELECT *FROM Request where REQUEST_TO = '$association_name' && APPROVED = 'Approved'");
//for count start
$sqla="select count(FIRST_NAME) from request where REQUEST_TO = '$association_name'&& APPROVED = 'Approved'";
...
echo '<script type="text/javascript">alert("There is no more Association members!! ");</script>';
}
}
