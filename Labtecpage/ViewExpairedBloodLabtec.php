				...
				<td width="300">
					<div style="width:660px; height:600px; border:solid 4px #dldbeg; overflow:auto;">
						<div id="contentcenter"><br/>
							...
							<div class="loginBoxx">
								<fieldset style="border-radius: 25px; background-color: #e2e6fe; color:#147d98; height:auto; width:580px;">
									<div id="customers">
										<?php
										if ($con) {
											$sql = "SELECT * FROM blood WHERE bstatus='Expaired'";
											$recordfound = mysqli_query($con, $sql);

											if (mysqli_num_rows($recordfound) > 0) {
												echo "<h2 align='center'>The Expired Bloods In Our Stock</h2>";
...
<?php
		$sql="select * from bloodrequest WHERE status='seekerseenaccept' and Unread='yes'";
